  ...
  <section className="border-b-2 border-black bg-[#f4f4f0] relative overflow-hidden">
    ...
    <div className="container mx-auto px-6 py-24 md:py-32 relative z-10">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start md:items-end justify-between border-t-2 border-black pt-8 max-w-6xl">
        <p className="font-mono text-lg max-w-xl leading-relaxed">
      ...
      <div
        className="mt-12 inline-flex items-center gap-4 p-4 border-2 border-black bg-white shadow-[4px_4px_0_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0_0_#000] transition-all cursor-pointer max-w-md"
